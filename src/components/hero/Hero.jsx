...
export function Hero() {
    return (
        <Box id="hero" component={motion.section} py={10} display="flex" flexDirection={{ xs: 'column', md: 'row' }} alignItems="center" gap={6}>
            <Box flex={1}>
                <Typography color="primary" component='h1' variant="h3" fontWeight={500}>Nguyễn Hữu Bảo Trung</Typography>
                <Typography variant="h6" component='p' fontWeight={400} mt={2}>Aspiring Software Developer — Focused on React, Node.js & ASP.NET Core</Typography>
